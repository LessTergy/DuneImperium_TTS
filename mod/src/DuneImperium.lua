...
__bundle_register(
    ...
    function (require, _LOADED, __bundle_register, __bundle_modules)
        ...
        function onLoad()
            ...
            bag_friendship = {
                -- bag for 2 influence vp with factions
            ...
            for _, obj in ipairs(getObjects()) do
                if
                    (obj.getDescription() == "Techs FR" and locale == "en") or
                    (obj.getDescription() == "Techs EN" and locale == "fr")
                then
                    obj.setInvisibleTo(
                        {
                            "Red",
        ...
        function Pass(_, color)
            ...
            elseif reveal["Blue"] == 1 and reveal["Red"] == 1 and reveal["Green"] == 1 and reveal["Yellow"] == 1 then
                letsFight()
        ...
        function CountForce(name)
            ...
            for _, obj in ipairs(conseilObjects) do
                if obj.getName() == name .. " Councilor" then
                    test1 = 1
                end
            end
            for _, obj in ipairs(playerObjects) do
                if obj.hasTag("Restricted Ordnance") then
                    test2 = 1
                end
            end
            ...
            if force == 0 then
                marker_combat[name].setPositionSmooth(marker_combat_pos_ini[name], false, false)
            elseif force < 21 then
                marker_combat[name].setPositionSmooth(marker_combat_pos[force], false, false)
                marker_combat[name].setRotationSmooth({ 0, 180, 0 })
            else
                marker_combat[name].setPositionSmooth(marker_combat_pos[force - 20], false, false)
        ...
        function addTroopDefense()
            ...
            for _, obj in ipairs(table) do
                if obj.getName() == "Red Dreadnought" or obj.getName() == "Red dreadnought" then
                    joueur = "Red"
                elseif obj.getName() == "Blue Dreadnought" or obj.getName() == "Blue dreadnought" then
                    joueur = "Blue"
                elseif obj.getName() == "Green Dreadnought" or obj.getName() == "Green dreadnought" then
                    joueur = "Green"
                elseif obj.getName() == "Yellow Dreadnought" or obj.getName() == "Yellow dreadnought" then
                    joueur = "Yellow"
                end
            end
            if joueur == nil then
            ...
            if joueur ~= nil then
                ...
                for _, troop in ipairs(troops) do
                    if troop.getName() == joueur then
                        ...
                        local leaderName = ressources[joueur][6].getObjects()[1].getName()
        ...
        function onObjectEnterScriptingZone(zone, enter_object)
            ...
            if zone.guid == zone_combat.guid then
                ...
                if name == "Red" or name == "Blue" or name == "Green" or name == "Yellow" then
                    CountForce(name)
                end
            end
            ...
            if zone.guid == vp_zone["Yellow"].guid then
                ...
                if name == "2d469b" or name == "ff1ce6" then
                    ...
                    for _, obj in ipairs(objets) do
                        if
                            obj.getName() == "Red Flag" or obj.getName() == "Blue Flag" or obj.getName() == "Green Flag" or
                            obj.getName() == "Yellow Flag"
                        then
                            obj.destruct()
                        end
                    end
        ...
        function Friendship(faction, color)
            ...
            for _, value in ipairs(vp) do
                if value.getName() == faction .. " Friendship" then
                    test = 1
                end
            end
            if test == 0 then
    ...
    function (require, _LOADED, __bundle_register, __bundle_modules)
        ...
        function helperModule.isDeckContainsEnough(color, numberToDraw)
            ...
            if starterDeck == nil then
                ...
                if typeCheck == "Card" then
                    countCheck = 1
                end

                if countCheck < numberToDraw then
                    enoughCards = false
                end
            end
...
__bundle_register(
    ...
    function (require, _LOADED, __bundle_register, __bundle_modules)
        ...
        constants.ressources = {
            -- 1 : épices, 2 : solaris, 3 : eau, 4 : troupes, 5 : cartes, 6 : zone leader, 7 : swordmaster, 8 : zone swordmaster, 9 : conseiller, 10 : zone conseiller, 11 : zone bonus conseiller, 12 : zone conseiller vanilla
            ["Red"] = {
                getObjectFromGUID("3074d4"),
                getObjectFromGUID("576ccd"),
                getObjectFromGUID("692c4d"),
                getObjectFromGUID("8ea4af"),
                getObjectFromGUID("3a9e65"),
                getObjectFromGUID("66cdbb"),
                getObjectFromGUID("ed3490"),
                { -18.85, 1.71, 22.89 },
                getObjectFromGUID("f19a48"),
                { -0.83,  3,    9.52 },
                { -28.10, 2,    6.11 },
                { -1.04,  3,    9.59 }
            },
            ["Blue"] = {
                getObjectFromGUID("9cc286"),
                getObjectFromGUID("fa5236"),
                getObjectFromGUID("0afaeb"),
                getObjectFromGUID("b71dd9"),
                getObjectFromGUID("a0bb82"),
                getObjectFromGUID("681774"),
                getObjectFromGUID("a78ad7"),
                { -18.94, 1.71, 1.15 },
                getObjectFromGUID("f5b14a"),
                { -1.57,  3,    9.52 },
                { -28.25, 2,    -15.73 },
                { -1.76,  3,    9.59 }
            },
            ["Green"] = {
                getObjectFromGUID("22478f"),
                getObjectFromGUID("e597dc"),
                getObjectFromGUID("fa9522"),
                getObjectFromGUID("126c3c"),
                getObjectFromGUID("c7fb9b"),
                getObjectFromGUID("cf1486"),
                getObjectFromGUID("fb1629"),
                { 19.06, 1.66, 22.89 },
                getObjectFromGUID("a0028d"),
                { 0.82,  3,    9.52 },
                { 28.22, 2,    6.12 },
                { 0.63,  3,    9.59 }
            },
            ["Yellow"] = {
                getObjectFromGUID("78fb8a"),
                getObjectFromGUID("c5c4ef"),
                getObjectFromGUID("f217d0"),
                getObjectFromGUID("6af67a"),
                getObjectFromGUID("17a08e"),
                getObjectFromGUID("a677e0"),
                getObjectFromGUID("635c49"),
                { 18.85, 1.65, 1.15 },
                getObjectFromGUID("1be491"),
                { 1.55,  3,    9.52 },
                { 28.23, 2,    -15.97 },
                { 1.35,  3,    9.59 }
            }
...
__bundle_register(
    ...
    function (require, _LOADED, __bundle_register, __bundle_modules)
        ...
        function localeAssets.load()
            ...
            if currentLocale ~= "en" then
                ...
                for _, GUID in ipairs(starter_decks) do
                    loadDeck(GUID, localeAssets[currentLocale]["cardsStarterImperium"], imperiumCardBack, 4, 2, 8)
                end

                for _, GUID in ipairs(dune_decks) do
                    loadDeck(GUID, localeAssets[currentLocale]["cardsDunePlanet"], imperiumCardBack, 2, 2, 2)
                end

                loadDeck("014161", localeAssets[currentLocale]["cardsFoldspace"], imperiumCardBack, 3, 2, 6)

                loadDeck("7d34c9", localeAssets[currentLocale]["cardsLiaison"], imperiumCardBack, 4, 2, 8)

                loadDeck("8de6d5", localeAssets[currentLocale]["cardsTSMF"], imperiumCardBack, 5, 2, 10)

                loadDeck("99d41d", localeAssets[currentLocale]["cardsBaseImperium"], imperiumCardBack, 10, 7, 70)
                ...
                loadDeck(
                    constants.imperium_deck_immortality,
                ...
                loadCard(
                    constants.reclaimed_forces,
                    localeAssets[currentLocale]["cardReclaimedForces"],
                    imperiumCardBack
                )

                loadDeck(
                    constants.intrigue_base,
                ...
                loadDeck(
                    constants.intrigue_immortality,
                ...
                for _, guidEpic in ipairs(epic_cards) do
                    loadCard(guidEpic, localeAssets[currentLocale]["cardControlTheSpice"], imperiumCardBack)
                end

                for _, GUID in ipairs(experimentation_decks) do
                    loadDeck(GUID, localeAssets[currentLocale]["cardsExperimentation"], imperiumCardBack, 2, 2, 2)
                end
                ...
                if getObjectFromGUID(constants.tleilaxu_deck) ~= nil then -- ça va changer le GUID du deck tleilaxu, besoin de le faire qu'une fois.
                    ...
                    for i = 1, 19 do
                        Wait.time(
                            function ()
                                card =
                                    tleilaxu_deck.takeObject(
                                        {
                                            position = tleilaxu_deck.getPosition() + Vector({ 0, (0.2 * i), 0 }),
                                            rotation = { 0, 180, 180 },
                                            smooth = false
                                        }
                                    )
        ...
        localeAssets.fr = {
            yuna =
            "http://cloud-3.steamusercontent.com/ugc/2029467636440254532/CDAED205706CD8E32700B8A56C9BD387C5D72696/",
            hundro =
            "http://cloud-3.steamusercontent.com/ugc/2029467636440287844/A64F2D77C6F482F31B12EC97C2DEEBBDF45AF3F9/",
            memnon =
            "http://cloud-3.steamusercontent.com/ugc/2029468089262094752/36DB26EE194B780C9C879C74FC634C15433CE06A/",
            ariana =
            "http://cloud-3.steamusercontent.com/ugc/2029467636440480689/3C1CA2B3506FB7AD8B1B40DB1414F7461F6974C8/",
            ilesa =
            "http://cloud-3.steamusercontent.com/ugc/2029468089262092469/7A0FCC4CA1D0CAF19C8066776DC23A9631000997/",
            armand =
            "http://cloud-3.steamusercontent.com/ugc/2029467636440253818/98401D1D00D15DB3512E48BBD63B9922EE17EF71/",
            paul =
            "http://cloud-3.steamusercontent.com/ugc/2029468089262095259/008429F21B2898E4C2982EC7FB1AF422FDD85E24/",
            leto =
            "http://cloud-3.steamusercontent.com/ugc/2029467636440402017/152B626A2D773B224CFFF878E35CEFDBB6F67505/",
            tessia =
            "http://cloud-3.steamusercontent.com/ugc/2029468089262093029/6C34345ADF23EBD567DE0EE662B4920906F721F0/",
            rhombur =
            "http://cloud-3.steamusercontent.com/ugc/2029467636440274764/58A6CF3EB6EBDEAC4B5826C0D21408A3CC02E678/",
            rabban =

            "http://cloud-3.steamusercontent.com/ugc/2021593312048963078/DC8CA97CC8837799620DC818CF86A17E6AE21C7A/",
            scytale =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048926023/CCCE3E2850003D29577EE441DDE9F76C340CF67B/",
            wensicia =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048923600/50C3448B1B131BCCEDEF2489B8D55BD122436063/",
            irulan =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048920158/54684F67F54FBA44E0E919C09AE731EF6452609A/",
            norma =
            "http://cloud-3.steamusercontent.com/ugc/2021593312052178581/FFDA79B76F75EFF0D5FE13F8FB9A93907027FDB3/",
            miles =
            "http://cloud-3.steamusercontent.com/ugc/2021593766276340183/7A6796DC0800083D9A7B667BEE290FB59C9EF908/",
            feyd =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048912133/FE488A5E03313545438CD8DA4E52BAED4E903996/",
            esmar =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048901208/6389B462773D70A50810F6ED7D6D62670AE19107/",
            metulli =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048898591/31A0F66BAB24BB067FA817844AFC62CF7A9C6E6F/",
            margot =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048896971/5E8A0FD7841FA1E0E859CABB20629E90866DE770/",
            memnon2 =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048894378/54389935A815BF7D4475DD29DF06EA911957F87A/",
            hasimir =
            "http://cloud-3.steamusercontent.com/ugc/2021593766276332961/E664A9BDC5C848CE47A06349B983D7E1438F968A/",
            otto =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048891817/37A53D71D3D80F35ADA6ACB63EB75236B0812785/",
            abulurd =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048886235/2613FE67B82A7A60717655610E1DFAB668C24B77/",
            esmar2 =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048814518/FFCC4D10A115AF72BCFA88B6495AD2CBB47B913D/",
            rhombur2 =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048797174/A5C5C5F42EE00169BBD4CC92576DB8F585952CF0/",
            farok =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048740730/487626BF0B4B4176C00D76C6073710179BAE6A7E/",
            darwi =
            "http://cloud-3.steamusercontent.com/ugc/2021593312048731551/F18296C86EDCCDC244B98AE5AF9B0809A0D1651C/",
            xavier =
            "http://cloud-3.steamusercontent.com/ugc/2021593312049143257/8D87E9ECF612D69B4048E62046D115C5D8B895E1/",
            whitmore =
            "http://cloud-3.steamusercontent.com/ugc/2021593312049142091/2F525198F540FCB6292064CB53F7C37FF7CD905F/"
        }
...
__bundle_register(
    ...
    function (require, _LOADED, __bundle_register, __bundle_modules)
        ...
        i18n.locales.en = {
            ...
            tiedAlliance =
            "2 or more players are tied for the %s Alliance. Choose a tied player to give your Alliance to.",
            ...
            troopTransport =
            "%s recruited 3 Troops with the Troop Transports Technology and can deploy them immediately.",
            ...
            researchSpecimenBeetle =
            "%s get a Specimen and advance on the the Tleilaxu Track thanks to the Research Track.",
        ...
        i18n.locales.fr = {
            ...
            researchSpecimenBeetle =
            "%s obtient un Spécimen et avance sur la Piste Tleilaxu grâce à la Piste de Recherche.",
            ...
            reclaimedForcesScarabWarning =
            "Voulez-vous vraiment dépenser 3 Spécimens pour avancer sur la Piste Tleilaxu ?",
            ...
            clockModeActivated =
            "Mode Horloge activé, les chronos apparaîtront après que le Premier Conflit soit révélé.",
