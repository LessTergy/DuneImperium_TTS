-- Bundled by luabundle {"rootModuleName":"buy8.363f98.lua","version":"1.6.0"}
...
__bundle_register("buy8.363f98.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
i18n = require("i18n")
require("locales")
...
function onLoad()
    ...
    tleilaxuColumn = constants.tleilaxuRow[2]
    Zone = getObjectFromGUID(tleilaxuColumn.zoneGuid)
    pos = tleilaxuColumn.pos
    activateButton()
...
function Buy(object,pColor)
    buyModule.Buy(Zone, pColor, pos, activateButton, true)
end

end)
__bundle_register("BuyModule", function(require, _LOADED, __bundle_register, __bundle_modules)
i18n = require("i18n")
require("locales")
...
return __bundle_require("buy8.363f98.lua")
