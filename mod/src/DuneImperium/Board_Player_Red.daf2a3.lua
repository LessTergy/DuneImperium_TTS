-- Bundled by luabundle {"rootModuleName":"Board Player Red.daf2a3.lua","version":"1.6.0"}
...
__bundle_register("Board Player Red.daf2a3.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
function onCollisionEnter(info)
    ...
    if objComingIntoContact.hasTag("Mentat") then
        objComingIntoContact.setColorTint(ressources["Red"][7].getColorTint()) -- même couleur que le swordmaster (cause Esmar Tuek agents transparents)
        objComingIntoContact.addTag("Red")
    end
...
return __bundle_require("Board Player Red.daf2a3.lua")
