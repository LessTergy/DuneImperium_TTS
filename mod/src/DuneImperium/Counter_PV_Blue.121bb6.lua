-- Bundled by luabundle {"rootModuleName":"Counter PV Blue.121bb6.lua","version":"1.6.0"}
...
__bundle_register("Counter PV Blue.121bb6.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    -- compteur de Blue
    previous_score = -1
    ...
    function onload()
        ...
        vp_zone = constants.vp_zone["Blue"]
        marker = getObjectFromGUID("1b1e76")
        ...
        marker_pos = {
            ...
            { 10.41, 2.9, 2.81 }, --11
            { 10.41, 2.9, 4.01 }, --12
            { 10.40, 2.9, 5.05 } -- au dessus c'est le soleil
        }
...
return __bundle_require("Counter PV Blue.121bb6.lua")
