-- Bundled by luabundle {"rootModuleName":"Board Player Yellow.6037b3.lua","version":"1.6.0"}
...
__bundle_register("Board Player Yellow.6037b3.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
function onCollisionEnter(info)
    ...
    local objComingIntoContact = info.collision_object

    if objComingIntoContact.hasTag("Mentat") then
        objComingIntoContact.setColorTint(ressources["Yellow"][7].getColorTint()) -- même couleur que le swordmaster (cause Esmar Tuek agents transparents)
        objComingIntoContact.addTag("Yellow")
    end
...
return __bundle_require("Board Player Yellow.6037b3.lua")
