-- Bundled by luabundle {"rootModuleName":"Shaddam IV.2fb2f1.lua","version":"1.6.0"}
...
__bundle_register("Shaddam IV.2fb2f1.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Shaddam IV.2fb2f1.lua")
