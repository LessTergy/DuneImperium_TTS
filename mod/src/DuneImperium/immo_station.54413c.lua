-- Bundled by luabundle {"rootModuleName":"immo station.54413c.lua","version":"1.6.0"}
...
__bundle_register("immo station.54413c.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    i18n = require("i18n")
    require("locales")
    ...
    ResearchStation_zone = boardCommonModule.ResearchStation_zone
...
return __bundle_require("immo station.54413c.lua")
