-- Bundled by luabundle {"rootModuleName":"Xavier Harkonnen.83b4e1.lua","version":"1.6.0"}
...
__bundle_register("Xavier Harkonnen.83b4e1.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Xavier Harkonnen.83b4e1.lua")
