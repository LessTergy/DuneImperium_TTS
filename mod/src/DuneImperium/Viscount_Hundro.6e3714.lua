-- Bundled by luabundle {"rootModuleName":"Viscount Hundro.6e3714.lua","version":"1.6.0"}
...
__bundle_register("Viscount Hundro.6e3714.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    ...
    function claimLeader(GO, color)
        ...
        elseif getObjectFromGUID("4a3e76").getVar("hiddenPicks") == 1 then
            ...
            if color == "Red" or color == "Blue" or color == "Green" or color == "Yellow" then
                ...
                , GO.getName()), color)
                getObjectFromGUID(intrigue).deal(2, color)
                GO.setInvisibleTo({})
            else
...
return __bundle_require("Viscount Hundro.6e3714.lua")
