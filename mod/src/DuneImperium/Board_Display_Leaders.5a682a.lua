-- Bundled by luabundle {"rootModuleName":"Board Display Leaders.5a682a.lua","version":"1.6.0"}
...
__bundle_register("Board Display Leaders.5a682a.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
function onload()
    i18n = require("i18n")
    require("locales")
...
return __bundle_require("Board Display Leaders.5a682a.lua")
