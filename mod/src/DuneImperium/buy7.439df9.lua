-- Bundled by luabundle {"rootModuleName":"buy7.439df9.lua","version":"1.6.0"}
...
__bundle_register("buy7.439df9.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    i18n = require("i18n")
    require("locales")
    ...
    function onLoad()
        ...
        tleilaxuColumn = constants.tleilaxuRow[1]
...
return __bundle_require("buy7.439df9.lua")
