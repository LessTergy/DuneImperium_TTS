-- Bundled by luabundle {"rootModuleName":"Leto II Atreides.2b5be9.lua","version":"1.6.0"}
...
__bundle_register("Leto II Atreides.2b5be9.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Leto II Atreides.2b5be9.lua")
