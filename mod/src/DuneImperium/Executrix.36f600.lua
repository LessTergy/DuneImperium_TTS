-- Bundled by luabundle {"rootModuleName":"Executrix.36f600.lua","version":"1.6.0"}
...
__bundle_register("Executrix.36f600.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Executrix.36f600.lua")
