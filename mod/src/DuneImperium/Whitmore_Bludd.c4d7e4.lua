-- Bundled by luabundle {"rootModuleName":"Whitmore Bludd.c4d7e4.lua","version":"1.6.0"}
...
__bundle_register("Whitmore Bludd.c4d7e4.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Whitmore Bludd.c4d7e4.lua")
