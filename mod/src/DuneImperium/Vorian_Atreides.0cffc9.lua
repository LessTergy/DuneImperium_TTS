-- Bundled by luabundle {"rootModuleName":"Vorian Atreides.0cffc9.lua","version":"1.6.0"}
...
__bundle_register("Vorian Atreides.0cffc9.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Vorian Atreides.0cffc9.lua")
