-- Bundled by luabundle {"rootModuleName":"Darwi Odrade.2bf676.lua","version":"1.6.0"}
...
__bundle_register("Darwi Odrade.2bf676.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Darwi Odrade.2bf676.lua")
