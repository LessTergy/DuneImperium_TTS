-- Bundled by luabundle {"rootModuleName":"Rabban 'The Beast'.4cf050.lua","version":"1.6.0"}
...
__bundle_register("Rabban 'The Beast'.4cf050.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
spice = {
  ["Red"] = {getObjectFromGUID("3074d4")},
  ["Blue"] = {getObjectFromGUID("9cc286")},
  ["Green"] = {getObjectFromGUID("22478f")},
  ["Yellow"] = {getObjectFromGUID("78fb8a")}
}
solari = {
  ["Red"] = {getObjectFromGUID("576ccd")},
  ["Blue"] = {getObjectFromGUID("fa5236")},
  ["Green"] = {getObjectFromGUID("e597dc")},
  ["Yellow"] = {getObjectFromGUID("c5c4ef")}
}
  ...
  function claimLeader(GO, color)
      ...
      elseif getObjectFromGUID("4a3e76").getVar("hiddenPicks") == 1 then
        ...
        if color == "Red" or color == "Blue" or color == "Green" or color == "Yellow" then
          ...
          claimed = "claimed"
          updateSave()
          spice[color][1].call("incrementVal")
          solari[color][1].call("incrementVal")
...
return __bundle_require("Rabban 'The Beast'.4cf050.lua")
