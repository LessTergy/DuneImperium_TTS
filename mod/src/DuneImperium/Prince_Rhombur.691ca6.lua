-- Bundled by luabundle {"rootModuleName":"Prince Rhombur.691ca6.lua","version":"1.6.0"}
...
__bundle_register("Prince Rhombur.691ca6.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Prince Rhombur.691ca6.lua")
