-- Bundled by luabundle {"rootModuleName":"Baron Harkonnen.98cae8.lua","version":"1.6.0"}
...
__bundle_register("Baron Harkonnen.98cae8.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
constants = require("Constants")

leaderPos = constants.leaderPos

baron_bag = getObjectFromGUID("f89231")
...
return __bundle_require("Baron Harkonnen.98cae8.lua")
