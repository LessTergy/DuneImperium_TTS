-- Bundled by luabundle {"rootModuleName":"Hwi Noree.c714a6.lua","version":"1.6.0"}
...
__bundle_register("Hwi Noree.c714a6.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Hwi Noree.c714a6.lua")
