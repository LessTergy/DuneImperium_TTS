-- Bundled by luabundle {"rootModuleName":"Board Player Blue.6957f2.lua","version":"1.6.0"}
...
__bundle_register("Board Player Blue.6957f2.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    ...
    function onCollisionEnter(info)
        ...
        if objComingIntoContact.hasTag("Mentat") then
            objComingIntoContact.setColorTint(ressources["Blue"][7].getColorTint()) -- même couleur que le swordmaster (cause Esmar Tuek agents transparents)
            objComingIntoContact.addTag("Blue")
        end
    end
end)
...
return __bundle_require("Board Player Blue.6957f2.lua")
