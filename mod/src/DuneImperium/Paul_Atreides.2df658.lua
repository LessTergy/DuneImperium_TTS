-- Bundled by luabundle {"rootModuleName":"Paul Atreides.2df658.lua","version":"1.6.0"}
...
__bundle_register("Paul Atreides.2df658.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Paul Atreides.2df658.lua")
