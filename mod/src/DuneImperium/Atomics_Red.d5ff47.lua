-- Bundled by luabundle {"rootModuleName":"Atomics Red.d5ff47.lua","version":"1.6.0"}
...
__bundle_register("Atomics Red.d5ff47.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Atomics Red.d5ff47.lua")
