-- Bundled by luabundle {"rootModuleName":"Water.f217d0.lua","version":"1.6.0"}
...
__bundle_register("Water.f217d0.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
MIN_VALUE = 0
MAX_VALUE = 99
...
return __bundle_require("Water.f217d0.lua")
