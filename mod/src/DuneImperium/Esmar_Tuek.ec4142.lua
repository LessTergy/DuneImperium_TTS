-- Bundled by luabundle {"rootModuleName":"Esmar Tuek.ec4142.lua","version":"1.6.0"}
...
__bundle_register("Esmar Tuek.ec4142.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Esmar Tuek.ec4142.lua")
