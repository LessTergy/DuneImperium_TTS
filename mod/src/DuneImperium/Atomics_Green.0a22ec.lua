-- Bundled by luabundle {"rootModuleName":"Atomics Green.0a22ec.lua","version":"1.6.0"}
...
__bundle_register("Atomics Green.0a22ec.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Atomics Green.0a22ec.lua")
