-- Bundled by luabundle {"rootModuleName":"Spice.22478f.lua","version":"1.6.0"}
...
__bundle_register("Spice.22478f.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    MIN_VALUE = 0
    MAX_VALUE = 99
...
return __bundle_require("Spice.22478f.lua")
