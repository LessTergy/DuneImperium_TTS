-- Bundled by luabundle {"rootModuleName":"Atomics Yellow.7e10a9.lua","version":"1.6.0"}
...
__bundle_register("Atomics Yellow.7e10a9.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
atomicsModule = require("AtomicsModule")

function onLoad() atomicsModule.homeButton(self)
end

end)
__bundle_register("AtomicsModule", function(require, _LOADED, __bundle_register, __bundle_modules)
i18n = require("i18n")
require("locales")
...
return __bundle_require("Atomics Yellow.7e10a9.lua")
