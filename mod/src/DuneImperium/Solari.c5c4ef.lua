-- Bundled by luabundle {"rootModuleName":"Solari.c5c4ef.lua","version":"1.6.0"}
...
__bundle_register("Solari.c5c4ef.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    MIN_VALUE = 0
    MAX_VALUE = 99
...
return __bundle_require("Solari.c5c4ef.lua")
