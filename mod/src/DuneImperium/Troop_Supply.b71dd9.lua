-- Bundled by luabundle {"rootModuleName":"Troop Supply.b71dd9.lua","version":"1.6.0"}
...
__bundle_register("Troop Supply.b71dd9.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
function AddTroop2()
    ...
    for _, obj in ipairs(table_troop) do
        if obj.getName() == "Blue" then
            if count < 1 then
                obj.setPositionSmooth({0.86+troopb_x, 2, -6.83+troopb_z}, false, false)
...
return __bundle_require("Troop Supply.b71dd9.lua")
