-- Bundled by luabundle {"rootModuleName":"Earl Memnon.f3082c.lua","version":"1.6.0"}
...
__bundle_register("Earl Memnon.f3082c.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Earl Memnon.f3082c.lua")
