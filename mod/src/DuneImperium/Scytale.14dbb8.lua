-- Bundled by luabundle {"rootModuleName":"Scytale.14dbb8.lua","version":"1.6.0"}
...
__bundle_register("Scytale.14dbb8.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Scytale.14dbb8.lua")
