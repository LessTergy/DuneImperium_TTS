-- Bundled by luabundle {"rootModuleName":"Farok.73e664.lua","version":"1.6.0"}
...
__bundle_register("Farok.73e664.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Farok.73e664.lua")
