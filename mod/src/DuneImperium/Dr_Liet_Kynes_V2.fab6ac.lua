-- Bundled by luabundle {"rootModuleName":"Dr Liet Kynes V2.fab6ac.lua","version":"1.6.0"}
...
__bundle_register("Dr Liet Kynes V2.fab6ac.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Dr Liet Kynes V2.fab6ac.lua")
