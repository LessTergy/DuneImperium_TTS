-- Bundled by luabundle {"rootModuleName":"Duke Mutelli.5133d2.lua","version":"1.6.0"}
...
__bundle_register("Duke Mutelli.5133d2.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Duke Mutelli.5133d2.lua")
