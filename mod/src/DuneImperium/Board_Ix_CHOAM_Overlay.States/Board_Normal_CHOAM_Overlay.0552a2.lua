...
__bundle_register("Board Normal CHOAM Overlay.0552a2.lua",
...
__bundle_register("locales", function (require, _LOADED, __bundle_register, __bundle_modules)
    ...
    i18n.locales.en = {
        ...
        negociatorLimitWarning =
        "You cannot place more than 4 Negociators with the automated script cause of the limited space on the board !!",
