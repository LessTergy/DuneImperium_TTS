-- Bundled by luabundle {"rootModuleName":"Tylwyth Waff.551456.lua","version":"1.6.0"}
...
__bundle_register("Tylwyth Waff.551456.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
constants = require("Constants")

leaderPos = constants.leaderPos
intrigue = constants.intrigue_base 
...
,GO.getName()), color)
      constants.tleilaxuTokens[color].setPositionSmooth({3.40, 2, 25.44})
      getObjectFromGUID(intrigue).deal(1, color)
...
return __bundle_require("Tylwyth Waff.551456.lua")
