-- Bundled by luabundle {"rootModuleName":"Counter PV Green.caaba4.lua","version":"1.6.0"}
...
__bundle_register("Counter PV Green.caaba4.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
-- compteur de Green
previous_score = -1
...
function onload()
    ...
    vp_zone = constants.vp_zone["Green"]
    marker = getObjectFromGUID("76039f")
    ...
    marker_pos = {
        ...
        {10.41, 2.7, 2.81}, --11
        {10.41, 2.7, 4.01}, --12
        {10.40, 2.7, 5.05} -- au dessus c'est le soleil
    }    
...
return __bundle_require("Counter PV Green.caaba4.lua")
