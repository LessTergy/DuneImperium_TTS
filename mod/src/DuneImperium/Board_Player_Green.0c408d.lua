-- Bundled by luabundle {"rootModuleName":"Board Player Green.0c408d.lua","version":"1.6.0"}
...
__bundle_register("Board Player Green.0c408d.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
function onCollisionEnter(info)
    ...
    if objComingIntoContact.hasTag("Mentat") then
        objComingIntoContact.setColorTint(ressources["Green"][7].getColorTint()) -- même couleur que le swordmaster (cause Esmar Tuek agents transparents)
        objComingIntoContact.addTag("Green")
    end
...
return __bundle_require("Board Player Green.0c408d.lua")
