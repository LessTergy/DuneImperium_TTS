-- Bundled by luabundle {"rootModuleName":"Horatio Prime.fed94f.lua","version":"1.6.0"}
...
__bundle_register("Horatio Prime.fed94f.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Horatio Prime.fed94f.lua")
