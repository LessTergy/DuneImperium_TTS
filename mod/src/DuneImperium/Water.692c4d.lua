-- Bundled by luabundle {"rootModuleName":"Water.692c4d.lua","version":"1.6.0"}
...
__bundle_register("Water.692c4d.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    MIN_VALUE = 0
    MAX_VALUE = 99
...
return __bundle_require("Water.692c4d.lua")
