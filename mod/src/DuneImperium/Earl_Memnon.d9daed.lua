-- Bundled by luabundle {"rootModuleName":"Earl Memnon.d9daed.lua","version":"1.6.0"}
...
__bundle_register("Earl Memnon.d9daed.lua", function(require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Earl Memnon.d9daed.lua")
