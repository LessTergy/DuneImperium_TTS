-- Bundled by luabundle {"rootModuleName":"Counter PV Yellow.99a860.lua","version":"1.6.0"}
...
__bundle_register("Counter PV Yellow.99a860.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    -- compteur de Yellow
    previous_score = -1
    ...
    function onload()
        ...
        vp_zone = constants.vp_zone["Yellow"]
...
return __bundle_require("Counter PV Yellow.99a860.lua")
