-- Bundled by luabundle {"rootModuleName":"Cyrisan Kyre.f9d232.lua","version":"1.6.0"}
...
__bundle_register("Cyrisan Kyre.f9d232.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Cyrisan Kyre.f9d232.lua")
