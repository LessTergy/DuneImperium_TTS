-- Bundled by luabundle {"rootModuleName":"buy3.0a5f50.lua","version":"1.6.0"}
...
__bundle_register("buy3.0a5f50.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    i18n = require("i18n")
    require("locales")
...
return __bundle_require("buy3.0a5f50.lua")
