-- Bundled by luabundle {"rootModuleName":"Tessia Vernius.1839fa.lua","version":"1.6.0"}
...
__bundle_register("Tessia Vernius.1839fa.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Tessia Vernius.1839fa.lua")
