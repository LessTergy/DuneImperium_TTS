-- Bundled by luabundle {"rootModuleName":"Edrik IV.07a2eb.lua","version":"1.6.0"}
...
__bundle_register("Edrik IV.07a2eb.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Edrik IV.07a2eb.lua")
