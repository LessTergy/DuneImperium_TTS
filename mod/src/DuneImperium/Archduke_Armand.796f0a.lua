-- Bundled by luabundle {"rootModuleName":"Archduke Armand.796f0a.lua","version":"1.6.0"}
...
__bundle_register("Archduke Armand.796f0a.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
...
return __bundle_require("Archduke Armand.796f0a.lua")
