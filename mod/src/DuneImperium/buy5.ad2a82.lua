-- Bundled by luabundle {"rootModuleName":"buy5.ad2a82.lua","version":"1.6.0"}
...
__bundle_register("buy5.ad2a82.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    i18n = require("i18n")
    require("locales")
    ...
    function onLoad()
        ...
        imperiumColumn = constants.imperiumRow[5]
...
return __bundle_require("buy5.ad2a82.lua")
