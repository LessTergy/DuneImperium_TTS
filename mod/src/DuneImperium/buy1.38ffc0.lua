-- Bundled by luabundle {"rootModuleName":"buy1.38ffc0.lua","version":"1.6.0"}
...
__bundle_register("buy1.38ffc0.lua", function (require, _LOADED, __bundle_register, __bundle_modules)
    i18n = require("i18n")
    require("locales")
    ...
    function onLoad()
        ...
        imperiumColumn = constants.imperiumRow[1]
...
return __bundle_require("buy1.38ffc0.lua")
